defmodule Blogit.UserControllerTest do
  use Blogit.ConnCase
  ...
  @tag admin: true
  test "creates resource and redirects when data is valid", %{conn: conn, user_role: user_role,
  ...
  test "renders form for editing chosen resource when logged in as an admin",
    %{conn: conn, admin_user: admin_user, nonadmin_user: nonadmin_user} do
  ...
  @tag admin: true
  test "updates chosen resource and redirects when data is valid as user",
    %{conn: conn, nonadmin_user: nonadmin_user} do
    conn = login_user(conn, nonadmin_user)
  ...
  @tag admin: true
  test "updates chosen resource and redirects when data is valid as admin", %{conn: conn, admin_user: admin_user} do
    conn = login_user(conn, admin_user)
  ...
  @tag admin: true
  test "deeletes chosen resource when logged in as an admin",
