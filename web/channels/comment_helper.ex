defmodule Blogit.CommentHelper do
  ...
  defp is_authorized_user?(user, post) do
    (user && (user.id == post.user_id || Blogit.RoleChecker.is_admin?(user)))
  end
end
